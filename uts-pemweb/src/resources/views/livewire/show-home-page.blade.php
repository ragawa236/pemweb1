...
@php
  ...
  $beasiswa = Beasiswa::orderBy('id')->get();
@endphp
<main>
      ...
      <div class="col-lg-6">
        <div class="ps-lg-5 text-center">
          <img loading="lazy" decoding="async"
            ...
            style="max-height: 5000px; object-fit: cover;">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="section-title pt-4">
          <p class="text-primary text-uppercase fw-bold mb-3">List</p>
          <h1>Beasiswa Terbaru</h1>
          <p>Di bawah ini adalah kumpulan beasiswa terbaru yang masih berlaku dan bisa kalian akses yaa.</p>
        </div>
      </div>
